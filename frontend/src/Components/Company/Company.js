        ...
        <section className="">
          ...
          <article>
            <div className="m-10 grad-color">
              ...
              <p className="my-5">
                Our Vision is to become a leading global pharmaceutical company
                by providing high quality, affordable and innovative solutions
                for patients with diverse medical needs.
              </p>

              <p className="my-5">
                Consistent growth and sustainability is a multidimensional
                aspiration for all at Kaymed. We mainly focus on providing
                quality and affordable medicines to billions of ailing patients
                across geographies and bridging the gap of unmet needs of
                medical fraternity through continuous innovation. Our basic
                business philosophy, by its very nature, serves a social
                responsibility hence we have a far better reason than profits
                alone to drive our Performance.
              </p>

              <p className="my-5">
                As a part of our Corporate Social Responsibility the Company
                intends to make a positive difference to society. Our aim is to
                deliver superior and sustainable value to all our customers,
